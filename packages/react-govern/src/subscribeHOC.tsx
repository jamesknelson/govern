...
import { createElement, isValidElement, isValidOutlet, Component, ComponentClass, GovernElement, Outlet } from 'govern'
...
export function subscribe<T, WrapperProps=any, WrappedProps=any>(
  mapOwnPropsToElement: (props: any) => (GovernElement<any, T> | Outlet<T>),
...
export function subscribe<T, WrapperProps=any, WrappedProps=any>(
  element: GovernElement<any, T> | Outlet<T>,
  mapValueToProps?: (value: T, dispatch?: Function, ownProps?: WrapperProps) => any,
  mapDispatchToProps?: (dispatch: Function, initialValue?: T) => any,
  merge?: (valueProps?: any, dispatchProps?: any, ownProps?: WrapperProps) => WrappedProps
): (component: React.ComponentType<WrappedProps>) => React.ComponentClass<WrapperProps>;
...
export function subscribe(
  mapOwnPropsToElement:
    ((props) => Outlet<any> | GovernElement<any, any>) |
  ...
  let mapFn = mapOwnPropsToElement as (props) => (GovernElement<any, any> | Outlet<any>)
  
  if (isValidElement(mapOwnPropsToElement) || isValidOutlet(mapOwnPropsToElement)) {
